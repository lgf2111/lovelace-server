...
def rotate_key():
    ...
    os.environ["APPLICATION_SIGNATURE_KEY_TEMP"] = os.environ[
    ...
    set_key(
        dotenv_file,
        "APPLICATION_SIGNATURE_KEY",
        os.environ.get("APPLICATION_SIGNATURE_KEY"),
    )
    set_key(
        dotenv_file,
        "APPLICATION_SIGNATURE_KEY_TEMP",
        os.environ.get("APPLICATION_SIGNATURE_KEY_TEMP"),
    )
